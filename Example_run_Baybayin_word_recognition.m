...
%output=Baybayin_word_reader(Baybayin_Character_Classifier_00379, 'Baybayin Word - Daanan.png')
%output=Baybayin_word_reader(Baybayin_Character_Classifier_00379, 'Baybayin Word - Dito, Reto, Rito.png')
%output=Baybayin_word_reader(Baybayin_Character_Classifier_00379, 'Baybayin Word - Isang.png')
